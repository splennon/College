 ...
 * bytecode of the Thread.start() while recording
 *
 * @author Stephen Lennon stephen@overworld.org
 *
 *         Date: 2015-09-26
 */
public class ThreadRecordMethodVisitor extends AdviceAdapter {
     ...
     */
    public ThreadRecordMethodVisitor(final MethodVisitor mv, final int access,
    ...
    protected void onMethodEnter() {
        ...
        this.visitMethodInsn(Opcodes.INVOKESTATIC,
            "org/overworld/mimic/Record", "threadStart", "(J)V", false);
    }
}
